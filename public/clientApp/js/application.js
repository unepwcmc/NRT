!function(){var a=Handlebars.template,e=Handlebars.templates=Handlebars.templates||{};e["section.hbs"]=a(function(a,e,t,r,n){function s(a,e,r){var n,s,i="";return i+="\n  ",s={hash:{narrative:a},data:e},i+=l((n=t.addSubViewTo||a.addSubViewTo,n?n.call(a,r.thisView,"NarrativeView",s):o.call(a,"addSubViewTo",r.thisView,"NarrativeView",s)))+"\n"}this.compilerInfo=[4,">= 1.0.0"],t=this.merge(t,a.helpers),n=n||{};var i,h="",o=t.helperMissing,l=this.escapeExpression,p=this;return h+="<h1>Section</h1>\n",i=t.each.call(e,e.narratives,{hash:{},inverse:p.noop,fn:p.programWithDepth(1,s,n,e),data:n}),(i||0===i)&&(h+=i),h+='\n<a class="btn add-narrative">\n	Add Narrative\n</a>\n'}),e["narrative.hbs"]=a(function(a,e,t,r,n){this.compilerInfo=[4,">= 1.0.0"],t=this.merge(t,a.helpers),n=n||{};var s,i="",h="function",o=this.escapeExpression;return i+="<p class='body-text'>",(s=t.body)?s=s.call(e,{hash:{},data:n}):(s=e.body,s=typeof s===h?s.apply(e):s),i+=o(s)+"</p>\n"}),e["narrative-edit.hbs"]=a(function(a,e,t,r,n){this.compilerInfo=[4,">= 1.0.0"],t=this.merge(t,a.helpers),n=n||{};var s,i="",h="function",o=this.escapeExpression;return i+="<textarea class='body-text-field'>",(s=t.body)?s=s.call(e,{hash:{},data:n}):(s=e.body,s=typeof s===h?s.apply(e):s),i+=o(s)+"</textarea>\n<a class='btn btn-primary save-narrative'>Save changes</a>\n"})}();
...
(function() {
  ...
  Backbone.Views.NarrativeView = (function(_super) {
    ...
    NarrativeView.prototype.saveNarrative = function(event) {
      this.narrative.set('body', this.$el.find('.body-text-field').val().replace(/^\s+|\s+$/g, ''));
