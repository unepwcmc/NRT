!function(){var e=Handlebars.template,t=Handlebars.templates=Handlebars.templates||{};t["section.hbs"]=e(function(e,t,a,n,r){function i(e,t,n){var r,i,s="";return s+="\n  ",i={hash:{narrative:e},data:t},s+=h((r=a.addSubViewTo||e.addSubViewTo,r?r.call(e,n.thisView,"NarrativeView",i):p.call(e,"addSubViewTo",n.thisView,"NarrativeView",i)))+"\n"}this.compilerInfo=[4,">= 1.0.0"],a=this.merge(a,e.helpers),r=r||{};var s,o="",p=a.helperMissing,h=this.escapeExpression,l=this;return o+="<h1>Section</h1>\n",s=a.each.call(t,t.narratives,{hash:{},inverse:l.noop,fn:l.programWithDepth(1,i,r,t),data:r}),(s||0===s)&&(o+=s),o+='\n<a class="btn add-narrative">\n	Add Narrative\n</a>\n'}),t["report.hbs"]=e(function(e,t,a,n,r){this.compilerInfo=[4,">= 1.0.0"],a=this.merge(a,e.helpers),r=r||{};var i,s="",o="function",p=this.escapeExpression;return s+="<h1>"+p((i=t.report,i=null==i||i===!1?i:i.title,typeof i===o?i.apply(t):i))+"</h1>\n<p>"+p((i=t.report,i=null==i||i===!1?i:i.overview,typeof i===o?i.apply(t):i))+"</p>\n"}),t["narrative.hbs"]=e(function(e,t,a,n,r){this.compilerInfo=[4,">= 1.0.0"],a=this.merge(a,e.helpers),r=r||{};var i,s="",o="function",p=this.escapeExpression;return s+="<p class='content-text'>",(i=a.content)?i=i.call(t,{hash:{},data:r}):(i=t.content,i=typeof i===o?i.apply(t):i),s+=p(i)+"</p>\n"}),t["narrative-edit.hbs"]=e(function(e,t,a,n,r){this.compilerInfo=[4,">= 1.0.0"],a=this.merge(a,e.helpers),r=r||{};var i,s="",o="function",p=this.escapeExpression;return s+="<textarea class='content-text-field'>",(i=a.content)?i=i.call(t,{hash:{},data:r}):(i=t.content,i=typeof i===o?i.apply(t):i),s+=p(i)+"</textarea>\n<a class='btn btn-primary save-narrative'>Save changes</a>\n"})}();
