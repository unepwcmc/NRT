...
(function() {
  ...
  Backbone.Views.NarrativeView = (function(_super) {
    ...
    NarrativeView.prototype.saveNarrative = function(event) {
      ...
      this.narrative.set('content', this.$el.find('.content-text-field').val());
